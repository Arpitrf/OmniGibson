...
prior_front = np.array([
    ...
    [ 0.,     0.,     0.,    -0.011, -0.078,  0.,     0.,     0.,     0.3,    -1.   ],
    [ 0.,     0.,     0.,     0.013, -0.077,  0.,     0.,     0.,     0.3,    -1.   ],
])
...
def custom_reset(env, robot, episode_memory=None, grasp_mode=None): 
    ...
    if grasp_mode == "front":
        base_x_noise = np.random.uniform(-0.2, 0.05)
        base_y_noise = np.random.uniform(-0.1, 0.3)
    if grasp_mode == "side":
        base_x_noise = np.random.uniform(-0.03, 0.05)
        base_y_noise = np.random.uniform(-0.1, 0.0)
