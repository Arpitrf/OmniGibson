...
def custom_reset(env, robot, episode_memory=None): 
    ...
    # base_pos = np.array([0.4592, 0.0008, 0.0005])
    base_pos = np.array([0.3, -0.4, 0.0])
...
def primitive(episode_memory=None, episode_number=0):
    ...
    # new_pos = curr_pos + th.tensor([-0.2, -0.2, 0.0])
...
if fridge is not None:
    ...
    fridge.links["right_door"].mass = 20.0
    fridge.joints["j_right_door"].friction = 300.0
